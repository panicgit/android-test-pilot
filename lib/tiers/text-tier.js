...
exports.TextTier = void 0;
const abstract_tier_1 = require("./abstract-tier");
const android_1 = require("../android");
class TextTier extends abstract_tier_1.AbstractTier {
    name = "text";
    priority = 1;
    ...
    async execute(context) {
        ...
        const compiled = expectedLogcat.map(e => {
            try {
    ...
    findSessionForDevice(deviceId) {
        return android_1.AndroidRobot.getSessionByDevice(deviceId);
    }
}
exports.TextTier = TextTier;
//# sourceMappingURL=text-tier.js.map